...
namespace Sudoku.Solvers
{
   ...
   /// of the solver.
   /// This is perhaps the solver that best fits the description
   /// of the "Rule 0 solver" from the project example solver.
   /// </summary>
   public class PreprocessMVR : ISolvingAlgorithm
   {
      private Grid grid = null!;
      private const int BoardSidelength = 9;
      private int[,] ValidDigits = null!;

      public PreprocessMVR() { }
      public PreprocessMVR(Grid grid)
      {
         this.grid = grid;
      }
